...
שלח /help כדי לראות את כל הפקודות.''',
      ...
      'help_general_user': '\n/start - הפעל את הבוט\n/help - הצג הודעה זו\n/info - מידע על הבוט\n/ping - בדוק סטטוס\n/role - בדוק תפקיד משתמש (השב או טלפון)\n\n',
      'help_general_admin': '\n/start - הפעל את הבוט\n/help - הצג הודעה זו\n/info - מידע על הבוט\n/ping - בדוק סטטוס\n/role - בדוק תפקיד משתמש (השב או טלפון)\n/setlang <he|en> - שנה שפה\n\n',
        'help_rules': '*חוקים:*',
      'help_rules_user': '\n/rules - הצג חוקי קבוצה\n\n',
      'help_rules_admin': '\n/rules - הצג חוקי קבוצה\n/setrules <טקסט> - הגדר חוקים (מנהל)\n\n',
        'help_warns': '*אזהרות:*',
      'help_warns_user': '\n/warns - בדוק אזהרות (השב או טלפון)\n\n',
      'help_warns_admin': '\n/warns - בדוק אזהרות (השב או טלפון)\n/warn - אזהרה למשתמש (השב או טלפון)\n/resetwarns - אפס אזהרות (השב או טלפון)\n/setwarn <מספר> - הגדר מגבלת אזהרות (מנהל)\n\n',
        'help_moderation': '*ניהול:*',
      'help_moderation_admin': '''\n/kick - בעט משתמש (השב או טלפון)
   /ban - חסום משתמש (השב או טלפון)
...
💡 דוגמה: /aimodset toxicity 70''',
      ...
      'bot_info': '🤖 *Rose Bot*\n\nמזהה: {from_id}\nצ\'אט: {chat_id_value}',
      'warn_usage': '❌ השב להודעה של משתמש או כתוב מספר טלפון כדי להזהיר אותו',
        'warns_list': '⚠️ *אזהרות ({count}/{limit}):*\n',
      'resetwarns_usage': '❌ השב להודעה של משתמש או כתוב מספר טלפון כדי לאפס אזהרות',
      'kick_usage': '❌ השב להודעה של משתמש או כתוב מספר טלפון כדי להוציא אותו',
      'ban_usage': '❌ השב להודעה של משתמש או כתוב מספר טלפון כדי לחסום אותו',
      'role_usage': '❌ השב להודעה של משתמש או כתוב מספר טלפון כדי לבדוק תפקיד',
      'role_admin': '⭐ {user} הוא מנהל בקבוצה',
      'role_member': '👤 {user} הוא חבר בקבוצה',
      'role_unknown': 'ℹ️ לא ניתן לבדוק כרגע את התפקיד של {user}',
        ...
        'invite_sent_private': '📩 נשלחה הזמנה פרטית ל-{user} (הגדרות הפרטיות שלו מונעות הוספה ישירה)',
        'invite_sent_private_link': '📩 לא ניתן לצרף את {user} ישירות בגלל הגדרות הפרטיות שלו; נשלח אליו קישור הזמנה בפרטי',
        'invite_private_failed': '⚠️ לא ניתן לצרף את {user} ישירות בגלל הגדרות הפרטיות שלו, ניסיתי לשלוח הודעה פרטית עם קישור הזמנה אבל זה נכשל',
...
Send /help to see all commands.''',
      ...
      'help_general_user': '\n/start - Start the bot\n/help - Show this message\n/info - Bot information\n/ping - Check bot status\n/role - Check user role (reply or phone)\n\n',
      'help_general_admin': '\n/start - Start the bot\n/help - Show this message\n/info - Bot information\n/ping - Check bot status\n/role - Check user role (reply or phone)\n/setlang <code> - Set language (he/en)\n\n',
        'help_rules': '*Rules:*',
      'help_rules_user': '\n/rules - Show group rules\n\n',
      'help_rules_admin': '\n/rules - Show group rules\n/setrules <text> - Set group rules (admin)\n\n',
        'help_warns': '*Warns:*',
      'help_warns_user': '\n/warns - Check user warns (reply or phone)\n\n',
      'help_warns_admin': '\n/warns - Check user warns (reply or phone)\n/warn - Warn a user (reply or phone)\n/resetwarns - Reset warns (reply or phone)\n/setwarn <number> - Set warn limit (admin)\n\n',
        'help_moderation': '*Moderation:*',
      'help_moderation_admin': '''\n/kick - Kick user (reply or phone)
   /ban - Ban user (reply or phone)
...
💡 Example: /aimodset toxicity 70''',
      ...
      'bot_info': '🤖 *Rose Bot*\n\nID: {from_id}\nChat: {chat_id_value}',
      'warn_usage': '❌ Reply to a user message or provide a phone number to warn them',
        'warns_list': '⚠️ *Warnings ({count}/{limit}):*\n',
      'resetwarns_usage': '❌ Reply to a user message or provide a phone number to reset warns',
      'kick_usage': '❌ Reply to a user message or provide a phone number to kick them',
      'ban_usage': '❌ Reply to a user message or provide a phone number to ban them',
      'role_usage': '❌ Reply to a user message or provide a phone number to check role',
      'role_admin': '⭐ {user} is an admin in this group',
      'role_member': '👤 {user} is a member of this group',
      'role_unknown': 'ℹ️ Unable to check the role for {user} right now',
        ...
        'invite_sent_private': '📩 Private invitation sent to {user} (privacy settings prevent direct add)',
        'invite_sent_private_link': '📩 Cannot add {user} directly due to their privacy settings; sent an invite link privately',
        'invite_private_failed': '⚠️ Cannot add {user} directly due to their privacy settings; tried to send a private invite link but it failed',
...
COMMAND_HELP = {
   'he': {
      ...
      'warn': {'usage': '/warn <טלפון> [סיבה] או תשובה', 'desc': 'תן אזהרה למשתמש (השב להודעה או ציין טלפון)', 'example': '/warn 972501234567 ספאם', 'admin': True},
      'warns': {'usage': '/warns [טלפון]', 'desc': 'בדוק אזהרות למשתמש (השב להודעה או ציין טלפון)', 'example': '/warns 972501234567', 'admin': False},
      'resetwarns': {'usage': '/resetwarns [טלפון]', 'desc': 'אפס אזהרות למשתמש (השב להודעה או ציין טלפון)', 'example': '/resetwarns 972501234567', 'admin': True},
      'setwarn': {'usage': '/setwarn <מספר>', 'desc': 'הגדר מגבלת אזהרות', 'example': '/setwarn 3', 'admin': True},
      'kick': {'usage': '/kick [טלפון]', 'desc': 'בעט משתמש מהקבוצה (השב להודעה או ציין טלפון)', 'example': '/kick 972501234567', 'admin': True},
      'ban': {'usage': '/ban [טלפון] [סיבה]', 'desc': 'חסום משתמש מהקבוצה (השב להודעה או ציין טלפון)', 'example': '/ban 972501234567 ספאם', 'admin': True},
      'role': {'usage': '/role [טלפון]', 'desc': 'בדוק אם משתמש הוא מנהל (השב להודעה או ציין טלפון)', 'example': '/role 972501234567', 'admin': False},
   ...
   'en': {
      ...
      'warn': {'usage': '/warn <phone> [reason] or reply', 'desc': 'Warn a user (reply or provide phone)', 'example': '/warn 972501234567 spam', 'admin': True},
      'warns': {'usage': '/warns [phone]', 'desc': 'Check user warnings (reply or provide phone)', 'example': '/warns 972501234567', 'admin': False},
      'resetwarns': {'usage': '/resetwarns [phone]', 'desc': 'Reset user warnings (reply or provide phone)', 'example': '/resetwarns 972501234567', 'admin': True},
      'setwarn': {'usage': '/setwarn <number>', 'desc': 'Set warn limit', 'example': '/setwarn 3', 'admin': True},
      'kick': {'usage': '/kick [phone]', 'desc': 'Kick user from group (reply or provide phone)', 'example': '/kick 972501234567', 'admin': True},
      'ban': {'usage': '/ban [phone] [reason]', 'desc': 'Ban user from group (reply or provide phone)', 'example': '/ban 972501234567 spam', 'admin': True},
      'role': {'usage': '/role [phone]', 'desc': 'Check if a user is admin (reply or provide phone)', 'example': '/role 972501234567', 'admin': False},
