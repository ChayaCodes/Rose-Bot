...
from bots.telegram import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from bots.telegram.modules import ALL_MODULES
from bots.telegram.modules.helper_funcs.chat_status import is_user_admin
from bots.telegram.modules.helper_funcs.misc import paginate_modules
...
def kcfrsct_fnc(bot: Bot, update: Update):
    ...
    if _match:
        try:
            from bots.telegram.modules.sql.cust_filters_sql import get_btn_with_di
